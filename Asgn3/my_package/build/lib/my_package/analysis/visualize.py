...
def plot_visualization(pred, np_arr, r, g, b,show,idx,analysis,save_file=None):
    ...
    draw = ImageDraw.Draw(PIL_image)            # use this to draw on the images
    ...
    file = str(save_file)
    PIL_image.save(file+"/{}_v2.jpg".format(idx))    # save the image in the required folder with correct extension
